...
* **Dynamic Repository Cloning:** On request, the API clones a specified GitHub repository (defaults to `openbytelabs/aperium-repo`).
...
1.  Clone the repository:
   ```bash
    git clone [https://github.com/openbytelabs/aperium-api.git](https://github.com/openbytelabs/aperium-api.git)
    cd aperium-api
   ```
